...
public class LootCrate : MonoBehaviour {
	...
	public void _setupParticleSystems()
	{
		//some sanity checks
	...
	public bool IsOpen ()
	{
		return animate.GetCurrentAnimatorStateInfo(0).IsName("Open");
	}

	public bool IsClosed()
	{
		return	animate.GetCurrentAnimatorStateInfo(0).IsName("Idle") ||
				animate.GetCurrentAnimatorStateInfo(0).IsName("Close");
	}

	public bool IsOpening()
	{
		return animate.GetCurrentAnimatorStateInfo(0).IsName("Open") && IsOpeningOrClosing();
	}

	public bool IsClosing()
	{
		return animate.GetCurrentAnimatorStateInfo(0).IsName("Close") && IsOpeningOrClosing();
	}

	public bool IsOpeningOrClosing()
	{
		AnimatorStateInfo asi = animate.GetCurrentAnimatorStateInfo(0);
		return !animate.GetCurrentAnimatorStateInfo(0).IsName("Idle") && asi.normalizedTime < 1;
	}
